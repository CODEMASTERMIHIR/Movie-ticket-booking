...
public class loginform extends javax.swing.JFrame {
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
		...
		if(username.contains("mihir") && password.contains("test")){ 
    ...
    private void fillupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fillupActionPerformed
		...
		try {
			FileWriter writer = new FileWriter("C:\\Users\\hp\\Documents\\NetBeansProjects\\movieticketingbookingsystem\\src\\movieticketingbookingsystem\\forprint\\userinfo.txt", true);
			writer.write(id);
			writer.write("   /  ");
			writer.write(fname);
			writer.write("   /  ");
    ...
    private void DisplayDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DisplayDataActionPerformed
		try {
			String filePath = "C:\\Users\\hp\\Documents\\NetBeansProjects\\movieticketingbookingsystem\\src\\movieticketingbookingsystem\\forprint\\userinfo.txt";
